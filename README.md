...
<p align="left">
<a href="https://pypi.org/project/entity-linkings"><img alt="PyPi" src="https://img.shields.io/pypi/v/entity-linkings"></a>
...
# from the source
git clone git@github.com:naist-nlp/entity_linkings.git
cd entity_linkings
pip install .
