...
def evaluate(args: Namespace) -> None:
    ...
    if args.wandb:
        ...
        wandb.log({
            ...
            "reranker_model_name_or_path": reranker_config.get("model_name_or_path", None),
    ...
    metrics = reranker.evaluate(test_dataset, num_candidates=args.num_candidates, batch_size=args.test_batch_size)
...
def cli_main() -> None:
    ...
    parser.add_argument('--reranker_id', type=str, required=True, help='Name of the reranker model to use.')
    parser.add_argument('--reranker_model_name_or_path', type=str, default=None, help='Name of the reranker model to use.')
