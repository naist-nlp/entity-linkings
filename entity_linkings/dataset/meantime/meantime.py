...
_HOMEPAGE = "http://www.newsreader-project.eu/results/data/wikinews/"
_URL = {
    "en": "http://data.newsreader-project.eu/meantime/MEANTIME_English.zip",
    "du": "http://data.newsreader-project.eu/meantime/MEANTIME_Dutch.zip",
    "it": "http://data.newsreader-project.eu/meantime/MEANTIME_Italian.zip",
    "es": "http://data.newsreader-project.eu/meantime/MEANTIME_Spanish.zip",
}
_LICENCE = "CC BY-SA 4.0"

logger = datasets.utils.logging.get_logger(__name__)

class MEANTIME(GeneratorBasedBuilder):
    """
